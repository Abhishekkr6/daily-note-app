  ...
  return (
    <div className="p-6 space-y-6 flex flex-col items-center justify-center min-h-screen">
      <Card className="bg-card border-border shadow-lg max-w-md w-full">
        <CardHeader>
          <CardTitle className="flex items-center space-x-2 justify-center text-3xl font-bold heading">
        ...
        <CardContent className="space-y-6">
          ...
          <div className="flex flex-col space-y-3">
            <Button variant="default" size="lg" className="w-full btn" onClick={() => window.location.href = "/signup"}>
              <LogIn className="w-5 h-5 mr-2" /> Sign Up
            </Button>
            <Button variant="outline" size="lg" className="w-full btn" onClick={() => window.location.href = "/login"}>
